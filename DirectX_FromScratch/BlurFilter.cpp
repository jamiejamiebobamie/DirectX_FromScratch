	...
	int blurCount)
{
	...
	CD3DX12_RESOURCE_BARRIER resBarr = CD3DX12_RESOURCE_BARRIER::Transition(input,
		D3D12_RESOURCE_STATE_RENDER_TARGET, D3D12_RESOURCE_STATE_COPY_SOURCE);

	cmdList->ResourceBarrier(1, &resBarr);

	resBarr = CD3DX12_RESOURCE_BARRIER::Transition(mBlurMap0.Get(),
	...
	resBarr = CD3DX12_RESOURCE_BARRIER::Transition(mBlurMap1.Get(),
