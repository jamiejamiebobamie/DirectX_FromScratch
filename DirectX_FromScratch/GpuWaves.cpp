...
void GpuWaves::BuildResources(ID3D12GraphicsCommandList* cmdList)
{
	...
	CD3DX12_HEAP_PROPERTIES defaultHeapDesc1 = CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_DEFAULT);
	...
	CD3DX12_HEAP_PROPERTIES defaultHeapDesc2 = CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_DEFAULT);
	...
	CD3DX12_HEAP_PROPERTIES defaultHeapDesc3 = CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_DEFAULT);
	...
	CD3DX12_HEAP_PROPERTIES uploadHeapDesc1 = CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_UPLOAD);
	CD3DX12_HEAP_PROPERTIES uploadHeapDesc2 = CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_UPLOAD);

	CD3DX12_RESOURCE_DESC resDesc1 = CD3DX12_RESOURCE_DESC::Buffer(uploadBufferSize);
	CD3DX12_RESOURCE_DESC resDesc2 = CD3DX12_RESOURCE_DESC::Buffer(uploadBufferSize);
	...
	CD3DX12_RESOURCE_BARRIER resBarrierDesc = CD3DX12_RESOURCE_BARRIER::Transition(mPrevSol.Get(),
		D3D12_RESOURCE_STATE_COMMON, D3D12_RESOURCE_STATE_COPY_DEST);

	cmdList->ResourceBarrier(1, &resBarrierDesc);
	UpdateSubresources(cmdList, mPrevSol.Get(), mPrevUploadBuffer.Get(), 0, 0, num2DSubresources, &subResourceData);

	resBarrierDesc = CD3DX12_RESOURCE_BARRIER::Transition(mPrevSol.Get(),
		D3D12_RESOURCE_STATE_COPY_DEST, D3D12_RESOURCE_STATE_UNORDERED_ACCESS);

	cmdList->ResourceBarrier(1, &resBarrierDesc);

	resBarrierDesc = CD3DX12_RESOURCE_BARRIER::Transition(mCurrSol.Get(),
		D3D12_RESOURCE_STATE_COMMON, D3D12_RESOURCE_STATE_COPY_DEST);
	...
	resBarrierDesc  = CD3DX12_RESOURCE_BARRIER::Transition(mNextSol.Get(),
	...
	ID3D12PipelineState* pso)
{
	...
	if (t >= mTimeStep)
	{
		...
		CD3DX12_RESOURCE_BARRIER resBarrierDesc = CD3DX12_RESOURCE_BARRIER::Transition(mCurrSol.Get(),
